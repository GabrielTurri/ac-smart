...
INSERT INTO atividade_complementar (titulo, descricao, caminho_anexo, horas_solicitadas, data, horas_aprovadas, RA_aluno) VALUES
('Curso de Python', 'Curso online de Python para iniciantes', '/anexos/curso_python.pdf', 20, '2023-01-15', 20, 1),
('Workshop de IA', 'Participação no workshop de Inteligência Artificial', '/anexos/workshop_ia.pdf', 15, '2023-02-20', 15, 2),
('Seminário de TI', 'Seminário sobre novas tecnologias em TI', '/anexos/seminario_ti.pdf', 10, '2023-03-10', 10, 3);
